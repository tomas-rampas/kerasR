...
#'
#' @param alpha                   float >= 0. Negative slope coefficient in [LeakyReLU]
#'                                and scale for the negative factor in [ELU].
#' @param theta                   float >= 0. Threshold location of activation in [ThresholdedReLU].
