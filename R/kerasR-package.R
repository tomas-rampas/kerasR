...
#' in this package are either native R objects or raw pointers to python objects,
#' making it possible for users to access the entire keras API. The main benefits
...
#' for a particular task. See the package vignettes for a more thorough explaination
#' and several larger, more practical examples.
#'
#' @author
